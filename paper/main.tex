...
\begin{framed}
\noindent \textbf{Box 1: A Quick Verification Protocol for Readers}

We recognize that papers claiming ``reasoning improvements'' are common and often fragile. Statistical averages can also mask failure modes. Rather than asking you to trust our pilot data, we provide a short protocol you can run with your own tools to probe the core claim.
...
\begin{enumerate}
    ...
    \end{quote}
    \item \textbf{The Domain-Specific Test (Optional):} To test utility for your domain, follow up with:
    \begin{quote}
    ``For [My Team's] engineering context, how would we adapt this scaffold to help our domain-specific workflow?''
    \end{quote}
\end{enumerate}
