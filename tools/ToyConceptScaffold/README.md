...
Three prompt formats (same info):
1. **BASELINE**: prose-like clauses with synonyms + filler tokens.
2. **CE-NEO**: `slivox=0/1`, `shearvon=0/1`, `frictal=0/1`, `compliq=0/1`.
3. **CE-ENG**: `slip_onset=0/1`, `shear_low=0/1`, `friction_drop=0/1`, `compliance_high=0/1`.
